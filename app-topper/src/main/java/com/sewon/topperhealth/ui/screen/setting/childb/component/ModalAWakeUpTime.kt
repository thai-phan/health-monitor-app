package com.sewon.topperhealth.ui.screen.setting.childb.component
...
import com.sewon.topperhealth.ui.screen.setting.childb.UiStateB
...
fun ModalAWakeUpTime(
  ...
  ModalBottomSheet(
    ...
    Column(
      ...
      Text(stringResource(R.string.wakeup_time), style = topperTypography.titleLarge)
